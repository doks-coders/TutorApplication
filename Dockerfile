...
COPY ./*.csproj ./
COPY ./TutorApplication.ApplicationCore/*.csproj ./TutorApplication.ApplicationCore/
COPY ./TutorApplication.Infrastructure/*.csproj ./TutorApplication.Infrastructure/
COPY ./TutorApplication.SharedModels/*.csproj ./TutorApplication.SharedModels/
COPY ./TutorApplication/*.csproj ./TutorApplication/

# Repeat this for any other projects

# Restore dependencies for each project
RUN dotnet restore ./TutorApplication.ApplicationCore/TutorApplication.ApplicationCore.csproj
RUN dotnet restore ./TutorApplication.Infrastructure/TutorApplication.Infrastructure.csproj
RUN dotnet restore ./TutorApplication.SharedModels/TutorApplication.SharedModels.csproj
RUN dotnet restore ./TutorApplication/TutorApplication.csproj
# Repeat this for any other projects
...
ENTRYPOINT [ "dotnet", "TutorApplication.dll" ]
